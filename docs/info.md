...
- **2 Compute Cores**, each with 32 systolic arrays of 4×4 FMA grids (512 FMAs per core, 1024 total)
- **Q1.15 Fixed-Point Arithmetic** — bounded `[-1, 1]` range optimised for normalised neural network weights and activations
- **Instruction Cache** — 64-entry per-core cache for program memory
