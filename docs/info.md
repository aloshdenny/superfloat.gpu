...
- **1 Compute Core** with 4 threads per block and 2 systolic arrays of 2×2 FMA grids (8 FMAs total)
...
- **4 data + 1 program** external memory channels, time-multiplexed over the bidirectional I/O bus
