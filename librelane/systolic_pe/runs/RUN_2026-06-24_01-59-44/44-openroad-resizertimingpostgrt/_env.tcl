...
set ::env(TECH_LEF) /Users/aoxo/.ciel/ciel/sky130/versions/74c0e6b118a67d94c24172143d3bd597473fa63d/sky130A/libs.ref/sky130_fd_sc_hd/techlef/sky130_fd_sc_hd__nom.tlef
set ::env(MACRO_LEFS) ""
...
set ::env(MAX_CAPACITANCE_CONSTRAINT) 0.25
set ::env(CLOCK_UNCERTAINTY_CONSTRAINT) 0.20
set ::env(CLOCK_TRANSITION_CONSTRAINT) 0.25
set ::env(TIME_DERATING_CONSTRAINT) 5
set ::env(IO_DELAY_CONSTRAINT) 0.1
...
set ::env(DESIGN_NAME) systolic_pe
set ::env(CLOCK_PERIOD) 20.0
set ::env(CLOCK_PORT) clk
set ::env(DIE_AREA) "0.0 0.0 160.0 200.0"
set ::env(EXTRA_EXCLUDED_CELLS) "sky130_fd_sc_hd__clkdlybuf4s15_1 sky130_fd_sc_hd__clkdlybuf4s15_2 sky130_fd_sc_hd__clkdlybuf4s18_1 sky130_fd_sc_hd__clkdlybuf4s18_2 sky130_fd_sc_hd__clkdlybuf4s25_1 sky130_fd_sc_hd__clkdlybuf4s25_2 sky130_fd_sc_hd__clkdlybuf4s50_1 sky130_fd_sc_hd__clkdlybuf4s50_2 sky130_fd_sc_hd__dlygate4sd1_1 sky130_fd_sc_hd__dlygate4sd2_1 sky130_fd_sc_hd__dlygate4sd3_1 sky130_fd_sc_hd__dlymetal6s2s_1 sky130_fd_sc_hd__dlymetal6s4s_1 sky130_fd_sc_hd__dlymetal6s6s_1 sky130_fd_sc_hd__buf_16 sky130_fd_sc_hd__inv_16"
set ::env(FALLBACK_SDC) /nix/store/38q40jfdrbmaz6c7rq2km1bipdi0873m-python3-3.13.9-env/lib/python3.13/site-packages/librelane/scripts/base.sdc
...
set ::env(GRT_RESIZER_HOLD_SLACK_MARGIN) 0.08
set ::env(GRT_RESIZER_SETUP_SLACK_MARGIN) 0.20
set ::env(GRT_RESIZER_HOLD_MAX_BUFFER_PCT) 80
set ::env(GRT_RESIZER_SETUP_MAX_BUFFER_PCT) 20
set ::env(GRT_RESIZER_ALLOW_SETUP_VIOS) 0
set ::env(GRT_RESIZER_SETUP_GATE_CLONING) 0
set ::env(GRT_RESIZER_RUN_GRT) 1
set ::env(GRT_RESIZER_SETUP_BUFFERING) 1
set ::env(GRT_RESIZER_SETUP_BUFFER_REMOVAL) 1
set ::env(GRT_RESIZER_SETUP_REPAIR_TNS_PCT) 50
set ::env(GRT_RESIZER_FIX_HOLD_FIRST) 0
set ::env(CURRENT_ODB) /Users/aoxo/vscode/superfloat.gpu/librelane/systolic_pe/runs/RUN_2026-06-24_01-59-44/43-openroad-repairantennas/1-openroad-diodeinsertion/systolic_pe.odb
set ::env(SAVE_ODB) /Users/aoxo/vscode/superfloat.gpu/librelane/systolic_pe/runs/RUN_2026-06-24_01-59-44/44-openroad-resizertimingpostgrt/systolic_pe.odb
set ::env(SAVE_DEF) /Users/aoxo/vscode/superfloat.gpu/librelane/systolic_pe/runs/RUN_2026-06-24_01-59-44/44-openroad-resizertimingpostgrt/systolic_pe.def
set ::env(SAVE_SDC) /Users/aoxo/vscode/superfloat.gpu/librelane/systolic_pe/runs/RUN_2026-06-24_01-59-44/44-openroad-resizertimingpostgrt/systolic_pe.sdc
set ::env(SAVE_NL) /Users/aoxo/vscode/superfloat.gpu/librelane/systolic_pe/runs/RUN_2026-06-24_01-59-44/44-openroad-resizertimingpostgrt/systolic_pe.nl.v
set ::env(SAVE_PNL) /Users/aoxo/vscode/superfloat.gpu/librelane/systolic_pe/runs/RUN_2026-06-24_01-59-44/44-openroad-resizertimingpostgrt/systolic_pe.pnl.v
